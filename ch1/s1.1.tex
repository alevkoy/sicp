...
(define (test x y) 
  (if (= x 0) 
      ...
      y))
	\end{lstlisting}
	Then he evaluates the expression \lstinline|(test 0 (p))|. What behavior
	...
	special form \lstinline|if| is the same whether the interpreter is using
...
Attempting to evaluate \lstinline|(p)| will recurse infinitely and thus never
...
evaluate \lstinline|(p)| and run forever without result.
